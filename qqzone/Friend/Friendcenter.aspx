<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Friendcenter.aspx.cs" Inherits="Friendcenter" MasterPageFile="FriendMasterPage.master" %>
            ...
            <ItemTemplate>
                ...
                <asp:Repeater ID="RptComment" runat="server" OnItemCommand="RptComment_ItemCommand" OnItemDataBound="RptComment_ItemDataBound" >
                    <ItemTemplate>
                        ...
                        <asp:LinkButton ID="LinkButton1" runat="server" Text="回复" CommandName="reply"  ></asp:LinkButton>                      
                ...
                <asp:TextBox ID="txtComment" runat="server" Height="20px" Width="500px"></asp:TextBox>
