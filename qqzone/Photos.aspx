...
<asp:Content ID="Content1" ContentPlaceHolderId="ContentPlaceHolder1" runat="server">   
    ...
    <asp:ImageButton ID="ImageButton" runat="server" Height="80px" Width="80px" OnClick="ImageButton_Click" />
    <br />
    <asp:FileUpload ID="myFileUpload" runat="server" Visible="False" />
    <asp:Label ID="lbImage" runat="server"  Visible="False"></asp:Label>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnUpload" runat="server" OnClick="btnUpload_Click" style="height: 27px" Text="上传图片" Visible="False" />
    <asp:Button ID="btnreturn" runat="server" OnClick="btnreturn_Click" style="height: 27px" Text="返回" Visible="False" />
    <br />
